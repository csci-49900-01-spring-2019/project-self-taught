module ApplicationHelper
	$genders = ["Male", "Female"]
	$gender_options = [["Choose...", nil], ["Male", "male"], ["Female", "female"]]
	$grades = ["Independent Learner", "Middle School", "High School", "College Student", "Professor"]
	$grade_options = [["Choose...", nil], ["Independent Learner", 1], ["Middle School", 2], ["High School", 3], ["College Student", 4], ["Professor", 5]]
